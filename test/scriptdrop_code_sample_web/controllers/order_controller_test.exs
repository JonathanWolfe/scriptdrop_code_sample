defmodule ScriptdropCodeSampleWeb.OrderControllerTest do
  use ScriptdropCodeSampleWeb.ConnCase

  alias ScriptdropCodeSample.Orders

  @create_attrs %{canceled: true, completed: true, dropoff_time: "2010-04-17T14:00:00Z", pickup_time: "2010-04-17T14:00:00Z"}
  @update_attrs %{canceled: false, completed: false, dropoff_time: "2011-05-18T15:01:01Z", pickup_time: "2011-05-18T15:01:01Z"}
